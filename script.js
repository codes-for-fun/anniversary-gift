...
function loadChapterContent() {
    ...
    const chapters = {
        ...
        "10": { title: "Cutest Shenanigans", text: "One morning I woke up and you told me to look out of my bedroom window for a surprise - and surprised I was! - to see you had arranged the useless sticks in words that meant the world to me. It was such a mischievous and unique way to wish me a happy anniversary. I've never been surprised like that before.", hasGame: "sticks" }
    };
...
function startKissGame() {
    ...
    <div class="kiss-game-wrapper">
        <p class="game-instruction">Surprise him! ❤️</p>
